    ...
    <nav class="navbar navbar-expand-xxl navbar-expand-xl navbar-expand-lg navbar-expand-md p-3">
        <div class="container-fluid me-xxl-3 me-xl-3 me-lg-3 me-0">
            ...
            <div class="collapse navbar-collapse flex-row-reverse" id="navmenu">
                <ul class="navbar-nav">
                    <li class="nav-item flex-row-reverse d-flex"><a href="{{ route('home') }}" class="nav-link active" aria-current="page">Home</a></li>
                    <li class="nav-item flex-row-reverse d-flex"><a href="{{ route('presupuesto.index') }}" class="nav-link">Presupuesto</a></li>
                    <li class="nav-item flex-row-reverse d-flex"><a href="{{ route('contacto.index') }}" class="nav-link">Contacto</a></li>
                </ul>
            </div>
        </div>
    </nav>
